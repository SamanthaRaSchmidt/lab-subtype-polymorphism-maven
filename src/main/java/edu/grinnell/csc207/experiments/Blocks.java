...
public class Blocks {
  ...
  public static void main(String[] args) throws Exception {
    ...
    AsciiBlock b5 = new Boxed(new Boxed(b3));
    AsciiBlock.print(pen, b5);

    separator(pen);
    pen.printf("b6 = new Boxed(b5)\n\n");
    AsciiBlock b6 = new Boxed(new Boxed(b5));
    ...
    separator(pen);
    AsciiBlock thing = new Boxed(new Surrounded(new Surrounded(new Line("A"), ' '), '*'));
    AsciiBlock.print(pen, thing);
